...
import { getBookings, cancelBooking } from "../../api/adminApi";
      ...
      <div className="admin-header">
        <div className="admin-header-left">
          ...
          <div className="admin-title-group">
            ...
            <span className="admin-count">{rawBookings.length} total</span>
          </div>
        </div>
      </div>
                    ...
                    <tr key={booking.booking_id}>
                      ...
                      <td className="actions-cell">
                        <button
                          ...
                          className={`cancel-btn ${booking.status === 'canceled' ? 'disabled' : ''}`}
